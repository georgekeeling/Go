...
Namespace GoCartaDLL
  Public Module VBdll
    ...
    Public Structure app
      Sub DoEvents()
        ' this is a dummy function, that must be replaced with the main program's DoEvents
      End Sub
    End Structure
    Public Application As app
    ...
    Public Function TestFriendly(c0 As Byte) As Boolean
      Dim c1 As Boolean, c2 As Boolean, c3 As Boolean
      c1 = ((c0 And 1) = 1)
      c2 = ((c0 And 2) = 2)
      c3 = ((c0 And 4) = 4)
      ' check that filthy condition
      If (c1 AndAlso c2 AndAlso Not c3) OrElse Not c1 Then Return True Else Return False
    End Function
...
#End If
    ...
    Public Function ScoreCompute(ByVal NN1 As Integer, ByVal japanese As Boolean, ByVal komi As Double,
                                 ByVal hc As Integer, ByVal whitemoves As Integer, ByVal blackmoves As Integer,
                                 ByVal inBoard(,) As Integer) As Double
      ' main routine
#If GUI Then
...
#End If
      ...
      Dim KON As Integer
      Console.WriteLine("ScoreCompute VB")
      Array.Copy(inBoard, board, 361)
